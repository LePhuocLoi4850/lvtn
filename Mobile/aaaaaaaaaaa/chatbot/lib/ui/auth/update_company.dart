...
class UpdateProfileCompanyPage extends StatefulWidget {
  static const routeName = '/update-company';

  final String userId;
  final String email;

  const UpdateProfileCompanyPage({
    Key? key,
  ...
  @override
  _UpdateProfileCompanyPageState createState() =>
      _UpdateProfileCompanyPageState();
}

class _UpdateProfileCompanyPageState extends State<UpdateProfileCompanyPage> {
  ...
  Future<void> _saveUserData() async {
    try {
      ...
      await _userProvider.updateUserData(updatedUserData);
