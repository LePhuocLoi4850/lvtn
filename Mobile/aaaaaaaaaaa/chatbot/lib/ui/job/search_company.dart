...
class SearchCompanyScreen extends StatefulWidget {
  static const routeName = '/Search-company';
  const SearchCompanyScreen({super.key});

  @override
  State<SearchCompanyScreen> createState() => _SearchJobScreenState();
}

class _SearchJobScreenState extends State<SearchCompanyScreen> {
              ...
              ElevatedButton(
                onPressed: () {
                  setState(() {
                    ...
                    _searchUser =
                        context.read<UsersManager>().searchTitle(name: '');
                  });
                },
                style: ButtonStyle(
