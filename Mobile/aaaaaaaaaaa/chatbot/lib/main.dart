...
import 'ui/auth/update_company.dart';
import 'ui/cart/cart_company_screen.dart';
        ...
        builder: (ctx, authManager, child) {
          return MaterialApp(
            ...
            routes: {
              ...
              CartCompanyScreen.routeName: (ctx) => const CartCompanyScreen(),
              ...
              UpdateProfileCompanyPage.routeName: (ctx) =>
                  const UpdateProfileCompanyPage(userId: '', email: ''),
