    ...
    return BottomNavigationBar(
      ...
      items: const [
        BottomNavigationBarItem(
          icon: Icon(Icons.home, color: Color.fromARGB(255, 178, 176, 178)),
          label: 'Home',
        ),
        BottomNavigationBarItem(
        ...
        BottomNavigationBarItem(
          icon: Icon(Icons.payment, color: Color.fromARGB(255, 178, 176, 178)),
          label: 'Order',
        ),
        BottomNavigationBarItem(
